  ...
  return (
    <div className="min-h-screen p-4">
      <div className="max-w-4xl mx-auto">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-2 text-text-muted hover:text-foreground mb-6 transition-colors"
        >
          <ArrowLeft size={20} />
          Назад к заданиям
        </button>
        ...
        <div className="homework-card">
          ...
          <div className="flex gap-4">
            <CustomButton
              ...
              className={`${isCompleted ? 'bg-surface-elevated text-foreground border border-border' : ''}`}
            >
